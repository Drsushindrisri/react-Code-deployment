...
function RaiseTicket() {
  ...
  const handleError = (e) => {
    ...
    if (!form[0].value || form[0].value.length < 3) {
      errors.name = "Please enter a vaild name";
    }
    if (!form[1].value || !ValidateEmail(form[1].value)) {
      errors.email = "Please enter a vaild email";
    }
    if (!form[2].value || form[2].value.length < 6) {
      errors.number = "Please enter a vaild number";
    }
    if (!form[3].value || form[3].value.length < 10) {
      errors.issue = "Please enter a vaild issue";
    }
    setErrors(errors);

    if (!errors.name && !errors.email && !errors.number && !errors.issue) {
      sendEmail();
    }
  };
  ...
  return (
    <>
      <SuccessAlert
        ...
        text="Your issue has been recorded"
        svg={TicketRaisedSvg()}
      />
...
const TicketRaisedSvg = () => (
  ...
  >
    <path
      id="b9ccae5a-ffdd-4f5c-9c1e-05af9f0f3372-198"
      data-name="Path 438"
    ...
    />
    <path
      id="f4ad1d06-bd03-4ced-a5c4-c19a65ab4ee5-199"
      data-name="Path 439"
    ...
    />
    <path
      id="baf785f8-b4c6-42cf-85bd-8a16037845f7-200"
      data-name="Path 442"
    ...
    />
    <path
      id="a14e4330-7125-4e03-a856-d6453c34f6cc-201"
      data-name="Path 443"
    ...
    />
    <path
      id="ac20a106-7eb8-4a45-8835-674ef3bf3222-202"
      data-name="Path 141"
    ...
    />
    <path
      id="a8878079-c7cd-406f-a434-8b15b914b9b4-203"
      data-name="Path 141"
    ...
    />
    <path
      id="af64f961-e9a2-4c53-a333-5060c7f850d2-204"
      data-name="Path 142"
    ...
    />
    <path
      id="baad4cfb-158d-4439-9cc3-22475bf47b22-205"
      data-name="Path 143"
    ...
    />
    <path
      id="f3456279-91e5-49ad-aa43-9838b26fb6ca-206"
      data-name="Path 142"
    ...
    />
    <path
      id="a3288adf-49f8-485f-8ae9-1e4f1a13d849-207"
      data-name="Path 143"
    ...
    />
    <path
      id="e63a5b48-5a7d-40a2-b9b0-6adec326348a-208"
      data-name="Path 142"
    ...
    />
    <path
      id="a1c669b4-dfc3-4cfa-a7be-66b71399844d-209"
      data-name="Path 143"
    ...
    />
    <path
      id="bfec50d1-ffb1-4de6-a9ef-a1085e40e016-210"
      data-name="Path 142"
    ...
    />
    <path
      id="bc9696ec-ec99-41d5-9116-3ad9737a38ac-211"
      data-name="Path 143"
